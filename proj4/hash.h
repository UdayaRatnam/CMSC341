...
class HashTable {
   ...
   bool linearProbingInsert(Person person);
   bool quadraticProbingInsert(Person person);
   bool linearProbingRemove(Person person);
   bool quadraticProbingRemove(Person person);
   void reHash(probing currProb);
